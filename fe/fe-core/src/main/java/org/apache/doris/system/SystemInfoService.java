...
public class SystemInfoService {
    ...
    class BeIdComparator implements Comparator<Backend> {
        public int compare(Backend a, Backend b) {
            // (int)(a.getId() - b.getId()) overflows when the id delta exceeds Integer.MAX_VALUE,
            // which breaks the Comparator contract and makes TimSort throw
            // "Comparison method violates its general contract!" during stream load BE selection.

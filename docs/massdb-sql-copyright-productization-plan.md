...
- 编制日期：2026-09-05
- 本版修订日期：2026-09-06
- 修订版本：v6，补充实际安装包、Java SBOM、原生链接证据与声明读取检查；最新复核见第 12 节。
- 检查基线：`bdd44bf2835b`
- 文档状态：实施中。首批页面、UI 声明生成、FE 材料组装与历史修改说明已落地；未完成项保持未勾选，详见第 9 节。尚未提交 Git 或形成可正式发布的完整交付。
...
在保留本次分发所需的上游及第三方 NOTICE 条目的前提下追加以下段落；不是将现有 NOTICE 整体替换为公司声明。年份和权属确认后才能用于正式发布。
...
- [ ] A03：确认版权起始年份；通过版本或统一元数据维护展示年份，不以浏览器时间自动改写历史版权事实。

...
struct TQueryOptions {
  ...
  // HASI geo index: allow the storage layer to narrow scans with the GEO index
  // (rollback switch for the v1 retrieval pushdown; v0 predicate rewrite is separate).
  204: optional bool enable_geo_index_query = true;

  // HASI geo index v1.5: let the index answer the circle predicate exactly (interior
